...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const rm = (obj, key) => { if (obj && typeof obj[key] === 'function') obj[key].call(obj); };
      rm(programRef.current,  'remove');
      rm(geometryRef.current, 'remove');
      rm(meshRef.current,     'remove');
      rm(rendererRef.current, 'destroy');
